...
export default function TwilioLogo(props: SVGProps<SVGSVGElement>) {
  ...
  useEffect(()=>{
    fetch('http://localhost:57772/csp/flagger/twilio/logo', {
...
(imgUrl === '') ? <svg fill="#F22F46" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" {...props}>
...
</svg> : <img src={imgUrl} width="30" height="30" style={{position: 'absolute', top: '20px', left: '20px'}} alt="Red dot" />
